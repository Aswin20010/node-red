...
module.exports = {
    init: function(server, settings, _runtimeAPI) {
        ...
        if (!settings.disableEditor) {
            ...
            // Custom Git Push — does not require projects feature to be enabled
            var gitpush = require("./gitpush");
            gitpush.init(settings, runtimeAPI);
            editorApp.post("/gitpush", needsPermission("flows.write"), gitpush.post);
