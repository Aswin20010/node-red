...
var RED = (function() {
    ...
    function loadEditor() {
        ...
        // Initialize the custom "My Action" button beside the Deploy button.
        // It uses prependTo(), so it appears to the right of Deploy in the toolbar.
        // To move it LEFT of Deploy, call RED.gitPushButton.init() before RED.deploy.init() above.
        if (RED.gitPushButton && RED.gitPushButton.init) {
            RED.gitPushButton.init();
        }
